...
void Board::tileDropping(sf::Int32 update_time){
	...
	tiles.back().setMySpeed(tiles.back().getMySpeed()+9.8*update_time*240.0/MILLION);	//240 is constant to modify qcceleration
...
//	double thickness_factor = 1.0/8.0;	//this makes an interesting board
